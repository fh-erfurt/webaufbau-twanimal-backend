...
router.post(
	...
	async (req, res) => res.json(await postService.exportPost(req.data, req.user))
)
 ...
 * @returns PostExport
 */
router.all('/post/:id', userService.getAuthenticatedUserMiddleware, postService.getPostMiddleware, async (req, res) =>
 ...
 * @returns String ('OK')
 */
router.post('/post/:id/delete', userService.authenticateMiddleware, postService.deletePostMiddleware, (req, res) =>
